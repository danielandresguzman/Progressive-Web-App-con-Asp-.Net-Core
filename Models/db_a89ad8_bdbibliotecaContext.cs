...
namespace MiProgressApp.Models
{
    public partial class db_a89ad8_bdbibliotecaContext : DbContext
    {
        public db_a89ad8_bdbibliotecaContext()
        {
        }

        public db_a89ad8_bdbibliotecaContext(DbContextOptions<db_a89ad8_bdbibliotecaContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<DetalleReserva> DetalleReservas { get; set; } = null!;
        ...
        public virtual DbSet<PaginaTipoUsuButton> PaginaTipoUsuButtons { get; set; } = null!;
        public virtual DbSet<PaginaTipoUsuario> PaginaTipoUsuarios { get; set; } = null!;
        public virtual DbSet<Pai> Pais { get; set; } = null!;
        public virtual DbSet<Persona> Personas { get; set; } = null!;
        public virtual DbSet<Reserva> Reservas { get; set; } = null!;
        public virtual DbSet<ReservaEstado> ReservaEstados { get; set; } = null!;
        public virtual DbSet<ReservaHistorial> ReservaHistorials { get; set; } = null!;
        public virtual DbSet<Sexo> Sexos { get; set; } = null!;
        public virtual DbSet<TipoLibro> TipoLibros { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=SQL8002.site4now.net;database=db_a89ad8_bdbiblioteca;uid=db_a89ad8_bdbiblioteca_admin;pwd=Daniel889");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Notificacione>(entity =>
            {
                entity.HasKey(e => e.Iidnotificacion)
                    .HasName("PK__Notifica__7DA9A90A61A270C1");

                entity.Property(e => e.Iidnotificacion).HasColumnName("IIDNOTIFICACION");

                entity.Property(e => e.Authnotificacion)
                    .HasMaxLength(500)
                    .IsUnicode(false)
                    .HasColumnName("AUTHNOTIFICACION");

                entity.Property(e => e.Bhabilitado).HasColumnName("BHABILITADO");

                entity.Property(e => e.Endpointnotificacion)
                    .HasMaxLength(500)
                    .IsUnicode(false)
                    .HasColumnName("ENDPOINTNOTIFICACION");

                entity.Property(e => e.P256dhnotificacion)
                    .HasMaxLength(500)
                    .IsUnicode(false)
                    .HasColumnName("P256DHNOTIFICACION");
            });
